...
public class SearchEngine {
	String title = "Gireesh Search Engine";
	Object[] okObject = {"Ok"};
	...
	public SearchEngine() {
		...
		JOptionPane.showOptionDialog(null, "Trie created with " + this.trie.size + " entries", title, 
	...
	public void writeResultsToFile(String[] indexTerm, ArrayList<String> result, int len, ArrayList<HashMap.Entry<Integer,int[]>> sortedTable) {
		...
		fileData.append("-----------------------------------------------------------------------------------------\r\n");
		len=Math.max(len, 10);
		fileData.append("Rank|Words"); for(int i=10;i<len;i++) fileData.append(" "); fileData.append("|");
